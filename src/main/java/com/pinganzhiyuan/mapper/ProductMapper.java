...
public interface ProductMapper {
    ...
    @Insert({ "insert into product (title, subtitle, ", "is_published, img_url, ", "url, weight, light_title, ",
            "edu, loan_floor, ", "loan_ceiling, duration_floor, ", "duration_ceiling, interest_floor, ",
            "interest_ceiling, credit_auth, ", "lender_name, lender_desc, ", "active_captcha_url, reg_interface_url, ",
            ...
            "#{edu,jdbcType=VARCHAR}, #{loanFloor,jdbcType=INTEGER}, ",
            "#{loanCeiling,jdbcType=INTEGER}, #{durationFloor,jdbcType=INTEGER}, ",
            "#{durationCeiling,jdbcType=INTEGER}, #{interestFloor,jdbcType=DOUBLE}, ",
            "#{interestCeiling,jdbcType=DOUBLE}, #{creditAuth,jdbcType=VARCHAR}, ",
     ...
     * @mbg.generated  Fri Dec 15 11:47:24 CST 2017
     */
    @Select({ "select", "id, title, subtitle, is_published, img_url, url, weight, light_title, edu, loan_floor, ",
    ...
    @Update({ "update product", "set title = #{title,jdbcType=VARCHAR},", "subtitle = #{subtitle,jdbcType=VARCHAR},",
            ...
            "loan_floor = #{loanFloor,jdbcType=INTEGER},", "loan_ceiling = #{loanCeiling,jdbcType=INTEGER},",
