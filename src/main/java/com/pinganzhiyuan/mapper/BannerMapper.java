...
public interface BannerMapper {
     ...
     * @mbg.generated  Mon Dec 11 19:51:29 CST 2017
     */
    @Insert({ "insert into banner (credit_ceiling, unit, ", "pass_rate)",
            "values (#{creditCeiling,jdbcType=INTEGER}, #{unit,jdbcType=VARCHAR}, ", "#{passRate,jdbcType=DOUBLE})" })
     ...
     * @mbg.generated  Mon Dec 11 19:51:29 CST 2017
     */
    @Select({ "select", "id, credit_ceiling, unit, pass_rate", "from banner", "where id = #{id,jdbcType=BIGINT}" })
    ...
    @Update({ "update banner", "set credit_ceiling = #{creditCeiling,jdbcType=INTEGER},",
            "unit = #{unit,jdbcType=VARCHAR},", "pass_rate = #{passRate,jdbcType=DOUBLE}",
