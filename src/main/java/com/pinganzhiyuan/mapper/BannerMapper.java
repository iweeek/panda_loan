...
public interface BannerMapper {
     ...
     * @mbg.generated  Mon Dec 11 14:02:08 CST 2017
     */
    @Insert({ "insert into banner (credit_ceiling, rate, ", "slide_news)",
            "values (#{creditCeiling,jdbcType=INTEGER}, #{rate,jdbcType=INTEGER}, ", "#{slideNews,jdbcType=VARCHAR})" })
     ...
     * @mbg.generated  Mon Dec 11 14:02:08 CST 2017
     */
    @Select({ "select", "id, credit_ceiling, rate, slide_news", "from banner", "where id = #{id,jdbcType=BIGINT}" })
    ...
    @Update({ "update banner", "set credit_ceiling = #{creditCeiling,jdbcType=INTEGER},",
            "rate = #{rate,jdbcType=INTEGER},", "slide_news = #{slideNews,jdbcType=VARCHAR}",
