...
public interface H5AppClientMapper {
	 ...
	 * @mbg.generated  Wed Apr 04 16:23:39 CST 2018
	 */
	@Insert({ "insert into h5_app (name, note, ", "url)",
			"values (#{name,jdbcType=VARCHAR}, #{note,jdbcType=VARCHAR}, ", "#{url,jdbcType=VARCHAR})" })
	 ...
	 * @mbg.generated  Wed Apr 04 16:23:39 CST 2018
	 */
	@Select({ "select", "id, name, note, url", "from h5_app", "where id = #{id,jdbcType=BIGINT}" })
