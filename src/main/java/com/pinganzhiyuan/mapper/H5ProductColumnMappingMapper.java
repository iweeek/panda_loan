...
public interface H5ProductColumnMappingMapper {
	 ...
	 * @mbg.generated  Wed Mar 28 11:14:47 CST 2018
	 */
	@Insert({ "insert into h5_product_column_mapping (h5_client_version_id, h5_column_key, ", "product_id, sequence, ",
			"status)", "values (#{h5ClientVersionId,jdbcType=BIGINT}, #{h5ColumnKey,jdbcType=VARCHAR}, ",
			"#{productId,jdbcType=BIGINT}, #{sequence,jdbcType=INTEGER}, ", "#{status,jdbcType=TINYINT})" })
	 ...
	 * @mbg.generated  Wed Mar 28 11:14:47 CST 2018
	 */
	@Select({ "select", "id, h5_client_version_id, h5_column_key, product_id, sequence, status",
			"from h5_product_column_mapping", "where id = #{id,jdbcType=BIGINT}" })
	 ...
	 * @mbg.generated  Wed Mar 28 11:14:47 CST 2018
	 */
	@Update({ "update h5_product_column_mapping", "set h5_client_version_id = #{h5ClientVersionId,jdbcType=BIGINT},",
			"h5_column_key = #{h5ColumnKey,jdbcType=VARCHAR},", "product_id = #{productId,jdbcType=BIGINT},",
			"sequence = #{sequence,jdbcType=INTEGER},", "status = #{status,jdbcType=TINYINT}",
