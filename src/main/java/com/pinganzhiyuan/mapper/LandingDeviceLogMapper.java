...
public interface LandingDeviceLogMapper {
    ...
    @Insert({ "insert into landing_device_log (url, ip, ", "landing_channel_id, landing_channel_uid, ",
            "sid, user_id, user_agent)", "values (#{url,jdbcType=VARCHAR}, #{ip,jdbcType=VARCHAR}, ",
            "#{landingChannelId,jdbcType=BIGINT}, #{landingChannelUid,jdbcType=VARCHAR}, ",
            "#{sid,jdbcType=VARCHAR}, #{userId,jdbcType=BIGINT}, #{userAgent,jdbcType=VARCHAR})" })
     ...
     * @mbg.generated  Tue Jan 23 15:05:52 CST 2018
     */
    @Select({ "select", "id, url, ip, landing_channel_id, landing_channel_uid, sid, user_id, user_agent",
            "from landing_device_log", "where id = #{id,jdbcType=BIGINT}" })
    ...
    @Update({ "update landing_device_log", "set url = #{url,jdbcType=VARCHAR},", "ip = #{ip,jdbcType=VARCHAR},",
            ...
            "landing_channel_uid = #{landingChannelUid,jdbcType=VARCHAR},", "sid = #{sid,jdbcType=VARCHAR},",
            "user_id = #{userId,jdbcType=BIGINT},", "user_agent = #{userAgent,jdbcType=VARCHAR}",
