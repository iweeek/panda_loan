...
public interface H5ClientVersionMapper {
	...
	@Insert({ "insert into h5_client_version (name, logo_url, ", "change_log, page_type, ",
			"client_version_id, ios_client_version_id, ", "h5_channel_id, h5_app_id, ", "platform_id, is_published, ",
			"publish_time)", "values (#{name,jdbcType=VARCHAR}, #{logoUrl,jdbcType=VARCHAR}, ",
			"#{changeLog,jdbcType=VARCHAR}, #{pageType,jdbcType=TINYINT}, ",
			"#{clientVersionId,jdbcType=BIGINT}, #{iosClientVersionId,jdbcType=BIGINT}, ",
	 ...
	 * @mbg.generated  Thu Mar 29 16:22:47 CST 2018
	 */
	@Select({ "select", "id, name, logo_url, change_log, page_type, client_version_id, ios_client_version_id, ",
			"h5_channel_id, h5_app_id, platform_id, is_published, publish_time", "from h5_client_version",
	...
	@Update({ "update h5_client_version", "set name = #{name,jdbcType=VARCHAR},",
			...
			"ios_client_version_id = #{iosClientVersionId,jdbcType=BIGINT},",
