...
public interface H5ClientVersionMapper {
     ...
     */
    @Insert({
        "insert into h5_client_version (name, logo_url, ",
        "change_log, client_version_id, ",
        "h5_channel_id, h5_app_id, ",
        "platform_id, is_published, ",
        "publish_time)",
        "values (#{name,jdbcType=VARCHAR}, #{logoUrl,jdbcType=VARCHAR}, ",
        "#{changeLog,jdbcType=VARCHAR}, #{clientVersionId,jdbcType=INTEGER}, ",
        "#{h5ChannelId,jdbcType=BIGINT}, #{h5AppId,jdbcType=BIGINT}, ",
        "#{platformId,jdbcType=TINYINT}, #{isPublished,jdbcType=BIT}, ",
    ...
    @Select({
        "select",
        "id, name, logo_url, change_log, client_version_id, h5_channel_id, h5_app_id, ",
        "platform_id, is_published, publish_time",
        "from h5_client_version",
        "where id = #{id,jdbcType=BIGINT}"
    })
     ...
     * @mbg.generated Tue Mar 13 17:05:25 CST 2018
     */
    int updateByExampleSelective(@Param("record") H5ClientVersion record, @Param("example") H5ClientVersionExample example);
     ...
     */
    @Update({
        "update h5_client_version",
        "set name = #{name,jdbcType=VARCHAR},",
          "logo_url = #{logoUrl,jdbcType=VARCHAR},",
          "change_log = #{changeLog,jdbcType=VARCHAR},",
          "client_version_id = #{clientVersionId,jdbcType=INTEGER},",
          "h5_channel_id = #{h5ChannelId,jdbcType=BIGINT},",
          "h5_app_id = #{h5AppId,jdbcType=BIGINT},",
