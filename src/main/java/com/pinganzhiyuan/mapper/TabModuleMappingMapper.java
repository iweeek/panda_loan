...
public interface TabModuleMappingMapper {
     ...
     * @mbg.generated  Wed Jan 24 17:29:12 CST 2018
     */
    @Insert({ "insert into tab_module_mapping (module_id, name, ", "icon_url, channel_id, ", "package_name, version, ",
            "sequence)", "values (#{moduleId,jdbcType=BIGINT}, #{name,jdbcType=VARCHAR}, ",
            "#{iconUrl,jdbcType=VARCHAR}, #{channelId,jdbcType=BIGINT}, ",
            "#{packageName,jdbcType=VARCHAR}, #{version,jdbcType=INTEGER}, ", "#{sequence,jdbcType=TINYINT})" })
     ...
     * @mbg.generated  Wed Jan 24 17:29:12 CST 2018
     */
    @Select({ "select", "id, module_id, name, icon_url, channel_id, package_name, version, sequence",
