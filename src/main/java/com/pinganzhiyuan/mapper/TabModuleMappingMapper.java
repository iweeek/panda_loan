...
public interface TabModuleMappingMapper {
     ...
     * @mbg.generated  Thu Jan 04 14:00:42 CST 2018
     */
    @Insert({ "insert into tab_module_mapping (module_id, name, ", "channel_id, package_name, ", "version, sequence)",
     ...
     * @mbg.generated  Thu Jan 04 14:00:42 CST 2018
     */
    @Select({ "select", "id, module_id, name, channel_id, package_name, version, sequence", "from tab_module_mapping",
    ...
    @Update({ "update tab_module_mapping", "set module_id = #{moduleId,jdbcType=BIGINT},",
            "name = #{name,jdbcType=VARCHAR},", "channel_id = #{channelId,jdbcType=BIGINT},",
