...
public interface DeviceLogMapper {
    ...
    @Insert({ "insert into device_log (uri, page_id, ", "user_id, ip, device_id, ", "user_agent, version, ",
            "channel_id, longitude, ", "latitude, geo_info)",
            ...
            "#{channelId,jdbcType=BIGINT}, #{longitude,jdbcType=DOUBLE}, ",
     ...
     * @mbg.generated  Tue Dec 19 11:44:36 CST 2017
     */
    @Select({ "select", "id, uri, page_id, user_id, ip, device_id, user_agent, version, channel_id, longitude, ",
            "latitude, geo_info", "from device_log", "where id = #{id,jdbcType=BIGINT}" })
