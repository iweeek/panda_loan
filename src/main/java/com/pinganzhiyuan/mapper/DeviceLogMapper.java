...
public interface DeviceLogMapper {
	 ...
	 * @mbg.generated  Thu Mar 29 16:22:47 CST 2018
	 */
	@Insert({ "insert into device_log (uri, page_id, ", "p_id, user_id, ip, ", "device_id, idfv, ",
			"idfa, user_agent, ", "url_type, sid, is_webview, ", "version, channel_id, ", "package_name, longitude, ",
			"latitude, geo_info, ", "jpush_id)", "values (#{uri,jdbcType=VARCHAR}, #{pageId,jdbcType=INTEGER}, ",
			"#{pId,jdbcType=BIGINT}, #{userId,jdbcType=BIGINT}, #{ip,jdbcType=VARCHAR}, ",
			"#{deviceId,jdbcType=VARCHAR}, #{idfv,jdbcType=VARCHAR}, ",
			"#{idfa,jdbcType=VARCHAR}, #{userAgent,jdbcType=VARCHAR}, ",
			...
			"#{latitude,jdbcType=DOUBLE}, #{geoInfo,jdbcType=VARCHAR}, ", "#{jpushId,jdbcType=VARCHAR})" })
	 ...
	 * @mbg.generated  Thu Mar 29 16:22:47 CST 2018
	 */
	@Select({ "select", "id, uri, page_id, p_id, user_id, ip, device_id, idfv, idfa, user_agent, url_type, ",
			"sid, is_webview, version, channel_id, package_name, longitude, latitude, geo_info, ", "jpush_id",
	...
	@Update({ "update device_log", "set uri = #{uri,jdbcType=VARCHAR},", "page_id = #{pageId,jdbcType=INTEGER},",
			...
			"device_id = #{deviceId,jdbcType=VARCHAR},", "idfv = #{idfv,jdbcType=VARCHAR},",
			"idfa = #{idfa,jdbcType=VARCHAR},", "user_agent = #{userAgent,jdbcType=VARCHAR},",
