...
public interface DeviceLogMapper {
     ...
     * @mbg.generated  Mon Dec 11 16:08:04 CST 2017
     */
    @Insert({ "insert into device_log (uri, user_id, ", "ip, user_agent, version)",
            "values (#{uri,jdbcType=VARCHAR}, #{userId,jdbcType=BIGINT}, ",
            "#{ip,jdbcType=VARCHAR}, #{userAgent,jdbcType=VARCHAR}, #{version,jdbcType=INTEGER})" })
     ...
     * @mbg.generated  Mon Dec 11 16:08:04 CST 2017
     */
    @Select({ "select", "id, uri, user_id, ip, user_agent, version", "from device_log",
     ...
     * @mbg.generated  Mon Dec 11 16:08:04 CST 2017
     */
    @Update({ "update device_log", "set uri = #{uri,jdbcType=VARCHAR},", "user_id = #{userId,jdbcType=BIGINT},",
            "ip = #{ip,jdbcType=VARCHAR},", "user_agent = #{userAgent,jdbcType=VARCHAR},",
            "version = #{version,jdbcType=INTEGER}", "where id = #{id,jdbcType=BIGINT}" })
