...
public interface DeviceLogMapper {
     ...
     * @mbg.generated  Thu Dec 14 18:52:42 CST 2017
     */
    @Insert({ "insert into device_log (uri, page_id, ", "user_id, ip, user_agent, ", "version, channel_id)",
            "values (#{uri,jdbcType=VARCHAR}, #{pageId,jdbcType=INTEGER}, ",
            "#{userId,jdbcType=BIGINT}, #{ip,jdbcType=VARCHAR}, #{userAgent,jdbcType=VARCHAR}, ",
     ...
     * @mbg.generated  Thu Dec 14 18:52:42 CST 2017
     */
    @Select({ "select", "id, uri, page_id, user_id, ip, user_agent, version, channel_id", "from device_log",
    ...
    @Update({ "update device_log", "set uri = #{uri,jdbcType=VARCHAR},", "page_id = #{pageId,jdbcType=INTEGER},",
            ...
            "channel_id = #{channelId,jdbcType=BIGINT}", "where id = #{id,jdbcType=BIGINT}" })
