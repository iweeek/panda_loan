...
public interface DeviceLogMapper {
    ...
    @Insert({ "insert into device_log (uri, page_id, ", "p_id, user_id, ip, ", "device_id, user_agent, ",
            "version, channel_id, ", "longitude, latitude, ", "geo_info)",
            ...
            "#{longitude,jdbcType=DOUBLE}, #{latitude,jdbcType=DOUBLE}, ", "#{geoInfo,jdbcType=VARCHAR})" })
     ...
     * @mbg.generated  Mon Dec 25 11:32:47 CST 2017
     */
    @Select({ "select", "id, uri, page_id, p_id, user_id, ip, device_id, user_agent, version, channel_id, ",
            "longitude, latitude, geo_info", "from device_log", "where id = #{id,jdbcType=BIGINT}" })
